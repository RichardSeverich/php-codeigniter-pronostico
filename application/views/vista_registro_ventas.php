					...
					foreach ($productos -> result() as $row)
					{
						echo '<tr >';
							  ...
							  //echo '<td>';
								...
								echo form_close();
								//echo '<td><a href="'.base_url().'index.php/controlador_ventas/direccionar_registro_ventas_elegir_productos/'.$row->id_producto.'/'.$id_venta.'">'.form_submit($attributes,'COMPRAR').'</a></td>';   
