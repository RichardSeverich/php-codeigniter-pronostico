<html>
	...
	<body>
		<center> 	
			...
			$ci_cliente="0";
			$id_ventas="0";
			echo form_open('controlador_ventas/direccionar_registro_ventas/'.$ci_cliente.'/'.$id_ventas.'',$attributes);    // OPEN
			...
			echo form_open('controlador_ventas/direccionar_menu_principal',$attributes);      // OPEN
