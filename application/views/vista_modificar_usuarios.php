...
<body>
			...
			<h3>LLENE LOS CAMPOS A MODIFICAR: </h3>
			</center> 			
					<?php  
						$attributes = array('class' => 'form', 'id' => 'login');
						echo form_open('controlador_usuarios/modificar_usuarios/'.$row->ci_usuario.'',$attributes);
					?>
				...
				<tr>
					 <td> 
					  <?php         
							...
							echo form_submit($attributes,'MODIFICAR');
							echo form_close();
					  ?>
					  </td> 
					  ...
					  <?php  
							...
							echo form_open('controlador_usuarios/direccionar_menu_gestionar_usuarios',$attributes); // primero  pongo el archivo php luego la funcion
